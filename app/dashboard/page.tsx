            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-purple-300">Real-time environmental data</p>
                </div>
              </div>
        ...
        <main className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="mb-8 bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/30 rounded-xl p-6 backdrop-blur-xl">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h2 className="text-2xl font-bold text-white mb-1">Overall Air Quality</h2>
                <p className="text-purple-300">Last updated: {currentTime.toLocaleString()}</p>
              </div>
                ...
                >
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-end gap-2">
                      ...
                      <span className="text-lg text-gray-400 mb-1">{sensor.unit}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 pt-4 border-t border-gray-700/50">
                    <TrendingUp 
                      className={`w-4 h-4 ${sensor.trend > 0 ? 'text-red-400 rotate-0' : 'text-green-400 rotate-180'}`} 
                    />
                    <span className="text-xs text-gray-400">
                      {sensor.trend > 0 ? '+' : ''}{sensor.trend.toFixed(1)}% from last hour
                    </span>
                  </div>
                </div>
              );
          ...
          <div className="mt-8 bg-gray-900/30 backdrop-blur-xl border border-purple-500/20 rounded-xl p-6">
            <h3 className="text-lg font-bold text-white mb-3">Air Quality Index Guide</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-white">Poor</p>
                  <p className="text-xs text-gray-400">May cause health effects</p>
                </div>
              </div>
            </div>
          </div>
